...
//____________________________________________________________________________________________________
abilityName = prompt("What is the Name of your Magic Item ?")
...
name = variableName + " = new MagicItem([\"" + abilityName + "\"],[\"" + name1true + name1 + "\"," + power1 + "],[\"" + name2true + name2 + "\"," + power3 + "],[\"" + name3true + name3 + "\"," + power3 + "]"     
